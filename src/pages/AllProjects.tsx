...
export default function AllProjects() {
  ...
  const getTypeColor = (type: string) => {
    const colors = {
      ...
      'Residential (G+19)': 'bg-orange-100 text-orange-800',
      'Residential (G+28)': 'bg-orange-100 text-orange-800',
      'Industrial': 'bg-red-100 text-red-800',
      '4 Star Hotel': 'bg-pink-100 text-pink-800',
      'Educational': 'bg-indigo-100 text-indigo-800',
      'Multiplex': 'bg-yellow-100 text-yellow-800',
